...
Description:				Return the highest integer from an array of integers
**************************************************************************************************************************************************/

-- Test me
-- SELECT dbo.fnHighestIntFromArray(0, 7, 4, 10, -5, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT)
-- SELECT dbo.fnHighestIntFromArray(1, 7, 4, 10, -5, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT)
-- SELECT dbo.fnHighestIntFromArray(0, -7, -4, -10, -5, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT)
-- SELECT dbo.fnHighestIntFromArray(1, -7, -4, -10, -5, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT)

CREATE FUNCTION [dbo].[fnHighestIntFromArray]
