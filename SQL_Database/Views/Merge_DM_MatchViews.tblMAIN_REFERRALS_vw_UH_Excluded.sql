...
CREATE VIEW [Merge_DM_MatchViews].[tblMAIN_REFERRALS_vw_UH_Excluded] AS	
		...
		SELECT		IsSCR
					...
					,NotRecurrence
					,ADT_REF_ID_SameSys
					,ADT_PLACER_ID_SameSys
					,FasterDiagnosisOrganisationCode
					,FasterDiagnosisExclusionReasonCode
					,LastUpdated
					,HashBytesValue
					,CARE_ID
					,PATIENT_ID
		...
		FROM		Merge_DM_MatchViews.tblMAIN_REFERRALS_vw_UH_FilterFlag()
		WHERE		MatchingFilter = 0
