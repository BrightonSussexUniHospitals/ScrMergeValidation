...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblREFERRAL_GYNAECOLOGY] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,CARE_ID
			,N_G1_GYNAE_ONCOLOGY = N_G1_GYNAE_ONCOLOGY COLLATE DATABASE_DEFAULT
			,N_G2_DIAGNOSTIC_ROUTE
			,R_FIGO = R_FIGO COLLATE DATABASE_DEFAULT
			,R_FIGO2 = R_FIGO2 COLLATE DATABASE_DEFAULT
			,R_FIGO3 = R_FIGO3 COLLATE DATABASE_DEFAULT
			,R_SECONDARY_DEPOSIT = R_SECONDARY_DEPOSIT COLLATE DATABASE_DEFAULT
			,L_QUESTIONNAIRE = L_QUESTIONNAIRE COLLATE DATABASE_DEFAULT
			,NODAL_STATUS_ID
