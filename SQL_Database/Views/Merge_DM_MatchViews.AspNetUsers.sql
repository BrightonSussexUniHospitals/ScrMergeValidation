...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[AspNetUsers] AS
...
**************************************************************************************************************************************************/
	...
	SELECT   CAST(1 AS tinyint) AS SrcSysID
			,Id
			,OldId
			,UserName = UserName COLLATE DATABASE_DEFAULT
			,Email = Email COLLATE DATABASE_DEFAULT
			,EmailConfirmed
			,PasswordHash = PasswordHash COLLATE DATABASE_DEFAULT
			,SecurityStamp = SecurityStamp COLLATE DATABASE_DEFAULT
			,PhoneNumber = PhoneNumber COLLATE DATABASE_DEFAULT
			...
			,OrganisationCode = OrganisationCode COLLATE DATABASE_DEFAULT
			,DepartmentID
			,FullName = FullName COLLATE DATABASE_DEFAULT
			,PasswordReset
			,AdminUserID
			,AssociatedCNSId
			,LastLockoutDate
