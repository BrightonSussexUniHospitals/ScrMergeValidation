...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[OrganisationSites] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,ID
			,ParentID
			,Code = Code COLLATE DATABASE_DEFAULT
			,Description = Description COLLATE DATABASE_DEFAULT
			,ReadOnly
			,E_TERTIARY_ENDPOINT = E_TERTIARY_ENDPOINT COLLATE DATABASE_DEFAULT
			,E_TERTIARY_CERT_CN = E_TERTIARY_CERT_CN COLLATE DATABASE_DEFAULT
			,E_TERTIARY_VERSION_ID
			,ReasonDeleted
			,IsDeleted
