...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblMDT_LIST] AS
...
**************************************************************************************************************************************************/
	...
	SELECT		CAST(1 AS tinyint) AS SrcSysID
				...
				,MEETING_ID					
				,MDT_DATE	
				,OTHER_SITE	= OTHER_SITE COLLATE DATABASE_DEFAULT
				,PT_ORDER					
				,PATIENT_ID					
				,CARE_ID					
				,PRE_POST =	PRE_POST COLLATE DATABASE_DEFAULT
				,DONE					
				,PREP					
				,COMMENTS =	COMMENTS COLLATE DATABASE_DEFAULT
				,RADIOLOGY_COMMENTS	= RADIOLOGY_COMMENTS COLLATE DATABASE_DEFAULT
				,HISTOLOGY_COMMENTS	= HISTOLOGY_COMMENTS COLLATE DATABASE_DEFAULT
				,MDT_COMMENTS = MDT_COMMENTS COLLATE DATABASE_DEFAULT
				,LAST_SAVED	 
				,ROOT_CAUSE_COMMENTS = ROOT_CAUSE_COMMENTS COLLATE DATABASE_DEFAULT
				,NEXT_OPA					 
				,TO_BE_SEEN_BY = TO_BE_SEEN_BY COLLATE DATABASE_DEFAULT
				,MDTLeadID					
				,CTX						
				,MDTDiscussionType			
