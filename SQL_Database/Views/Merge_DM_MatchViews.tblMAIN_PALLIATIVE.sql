...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblMAIN_PALLIATIVE] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			...
			,N_L39_PROVIDER = N_L39_PROVIDER COLLATE DATABASE_DEFAULT
			,N_L40_COMMUNITY = N_L40_COMMUNITY COLLATE DATABASE_DEFAULT
			,N_L41_TREATMENT = N_L41_TREATMENT COLLATE DATABASE_DEFAULT
			,N_L42_TREAT_DATE
			...
			,N_SPECIALIST = N_SPECIALIST COLLATE DATABASE_DEFAULT
			,L_TRIAL
	...
	FROM  [CancerRegister_WSHT]..tblMAIN_PALLIATIVE
	...
	SELECT  CAST(2 AS tinyint) AS SrcSysID
			...
			,ROOT_PRIM_ADJUSTMENT_COMMENTS = ROOT_PRIM_ADJUSTMENT_COMMENTS  COLLATE DATABASE_DEFAULT
			,ROOT_SUBPRIM_ADJUSTMENT_COMMENTS = ROOT_SUBPRIM_ADJUSTMENT_COMMENTS COLLATE DATABASE_DEFAULT
	FROM  [CancerRegister_BSUH]..tblMAIN_PALLIATIVE
GO
