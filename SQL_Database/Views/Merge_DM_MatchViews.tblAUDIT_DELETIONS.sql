...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblAUDIT_DELETIONS] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			...
			,DATE_DELETED
			,NHS_NUMBER = NHS_NUMBER COLLATE DATABASE_DEFAULT
			,HOSPITAL_NUMBER = HOSPITAL_NUMBER COLLATE DATABASE_DEFAULT
			,SURNAME = SURNAME COLLATE DATABASE_DEFAULT
			,FORENAME = FORENAME COLLATE DATABASE_DEFAULT
			,DATE_BIRTH
