...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblTERTIARY_REFERRALS_RECEIVED] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,TertiaryReferralID
			,DateReceived
			,RootCauseReceivedComments = RootCauseReceivedComments COLLATE DATABASE_DEFAULT
			,RootCauseReturnedComments = RootCauseReturnedComments COLLATE DATABASE_DEFAULT
			,RequestReceivedDate
