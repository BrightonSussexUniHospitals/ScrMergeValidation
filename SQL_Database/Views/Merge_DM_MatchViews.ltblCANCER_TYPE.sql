...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[ltblCANCER_TYPE] AS
...
**************************************************************************************************************************************************/
	...
	SELECT CAST(1 AS tinyint) AS SrcSysID
			,CANCER_TYPE_CODE = CANCER_TYPE_CODE COLLATE DATABASE_DEFAULT
			,CANCER_TYPE_DESC = CANCER_TYPE_DESC COLLATE DATABASE_DEFAULT
			,UROLOGY
			,HAEMATOLOGY
			,BREAST
			,CANCER_SITE
