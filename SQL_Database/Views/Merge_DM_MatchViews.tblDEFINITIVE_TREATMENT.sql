...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblDEFINITIVE_TREATMENT] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			...
			,TREATMENT_ADJ_DATE
	FROM  [WSHT_Deduplication]..tblDEFINITIVE_TREATMENT
	...
	SELECT  CAST(2 AS tinyint) AS SrcSysID
			...
			,ROOT_DTT_DATE_COMMENTS = ROOT_DTT_DATE_COMMENTS COLLATE DATABASE_DEFAULT
			,TREATMENT_ADJ_DATE
	FROM  [BSUH_Deduplication]..tblDEFINITIVE_TREATMENT
GO
