...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[ltblSTATUS] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,STATUS_CODE = STATUS_CODE COLLATE DATABASE_DEFAULT
			,STATUS_DESC = STATUS_DESC COLLATE DATABASE_DEFAULT
			,SHORT_DESC = SHORT_DESC COLLATE DATABASE_DEFAULT
			,ORDER_BY
			,RECURRENCE
			,IsTransfer
			,NoCancer
