...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblTRACKING_COMMENTS] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,COM_ID
			,CARE_ID
			,USER_ID = USER_ID COLLATE DATABASE_DEFAULT
			,DATE_TIME
			,COMMENTS = COMMENTS COLLATE DATABASE_DEFAULT
			,ROOT_CAUSE_TRACKING_NOTES_COMMENTS = ROOT_CAUSE_TRACKING_NOTES_COMMENTS COLLATE DATABASE_DEFAULT
	FROM	[CancerRegister_WSHT]..tblTRACKING_COMMENTS
	...
	SELECT  CAST(2 AS tinyint) AS SrcSysID
			...
			,COMMENTS = COMMENTS COLLATE DATABASE_DEFAULT
			,ROOT_CAUSE_TRACKING_NOTES_COMMENTS = ROOT_CAUSE_TRACKING_NOTES_COMMENTS COLLATE DATABASE_DEFAULT
	FROM	[CancerRegister_BSUH]..tblTRACKING_COMMENTS
GO
