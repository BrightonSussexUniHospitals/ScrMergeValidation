...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[ltblCONSULTANTS] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,CON_ID
			,NATIONAL_CODE = NATIONAL_CODE COLLATE DATABASE_DEFAULT
			,CON_CODE = CON_CODE COLLATE DATABASE_DEFAULT
			,CON_DESC = CON_DESC COLLATE DATABASE_DEFAULT
			,SPEC_CODE
			,TITLE = TITLE COLLATE DATABASE_DEFAULT
			,DEPT = DEPT COLLATE DATABASE_DEFAULT
			,COLORECTAL
			,GRADE = GRADE COLLATE DATABASE_DEFAULT
			,BAUS
			,IS_DELETED
			,UNKNOWN
