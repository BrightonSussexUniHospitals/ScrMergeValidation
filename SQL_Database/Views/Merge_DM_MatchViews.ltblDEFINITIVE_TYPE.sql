...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[ltblDEFINITIVE_TYPE] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			,TREAT_CODE = TREAT_CODE COLLATE DATABASE_DEFAULT
			,TREAT_DESC = TREAT_DESC COLLATE DATABASE_DEFAULT
			,ORDER_BY
			,POV_SUMMARY = POV_SUMMARY COLLATE DATABASE_DEFAULT
			,HANA_TX_PRE_CHEMO
			,HANA_TX_PRE_RADIO
			,HANA_TX_PRE_SURGERY
