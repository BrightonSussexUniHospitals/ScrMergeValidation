...
SET ANSI_NULLS ON
GO
CREATE VIEW [Merge_DM_MatchViews].[tblPathwayUpdateEvents] AS
...
**************************************************************************************************************************************************/
	...
	SELECT  CAST(1 AS tinyint) AS SrcSysID
			...
			,AdditionalDetails = AdditionalDetails COLLATE DATABASE_DEFAULT
			,OwnerID
			,OwnerRole = OwnerRole COLLATE DATABASE_DEFAULT
			,OwnerName = OwnerName COLLATE DATABASE_DEFAULT
			,TargetDate
			,Escalate
			,OrganisationID
			,ActionComplete
