CREATE TABLE [Merge_DM_Match].[tblMAIN_REFERRALS_Match_EntityPairs_Unique]
(
...
GO
CREATE UNIQUE CLUSTERED INDEX [PK_tblMAIN_REFERRALS_Match_EntityPairs_Unique] ON [Merge_DM_Match].[tblMAIN_REFERRALS_Match_EntityPairs_Unique] ([SrcSys_A], [Src_UID_A], [SrcSys_B], [Src_UID_B]) ON [PRIMARY]
GO
