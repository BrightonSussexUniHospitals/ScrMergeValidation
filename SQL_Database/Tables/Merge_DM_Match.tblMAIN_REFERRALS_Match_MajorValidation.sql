CREATE TABLE [Merge_DM_Match].[tblMAIN_REFERRALS_Match_MajorValidation]
(
...
GO
CREATE UNIQUE CLUSTERED INDEX [PK_tblMAIN_REFERRALS_Match_MajorValidation] ON [Merge_DM_Match].[tblMAIN_REFERRALS_Match_MajorValidation] ([SrcSys_Major], [Src_UID_Major]) ON [PRIMARY]
GO
