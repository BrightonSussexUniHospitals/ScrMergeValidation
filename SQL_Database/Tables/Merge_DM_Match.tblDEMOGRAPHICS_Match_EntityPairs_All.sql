CREATE TABLE [Merge_DM_Match].[tblDEMOGRAPHICS_Match_EntityPairs_All]
(
...
GO
CREATE UNIQUE CLUSTERED INDEX [PK_tblDEMOGRAPHICS_Match_EntityPairs_All] ON [Merge_DM_Match].[tblDEMOGRAPHICS_Match_EntityPairs_All] ([SrcSys_A], [Src_UID_A], [SrcSys_B], [Src_UID_B], [MatchType]) ON [PRIMARY]
GO
