CREATE TABLE [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded]
(
[IsSCR] [bit] NULL,
[SrcSys] [tinyint] NOT NULL,
[Src_UID] [varchar] (255) COLLATE Latin1_General_CI_AS NOT NULL,
[LinkedCareID] [int] NULL,
...
[ADT_REF_ID_SameSys] [varchar] (306) COLLATE Latin1_General_CI_AS NULL,
[ADT_PLACER_ID_SameSys] [varchar] (306) COLLATE Latin1_General_CI_AS NULL,
[FasterDiagnosisOrganisationCode] [varchar] (5) COLLATE Latin1_General_CI_AS NULL,
...
GO
ALTER TABLE [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ADD CONSTRAINT [PK_tblMAIN_REFERRALS_mvw_UH_Excluded] PRIMARY KEY CLUSTERED ([SrcSys], [Src_UID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_ADT_PLACER_ID_SameSys] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([ADT_PLACER_ID_SameSys]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_ADT_REF_ID_SameSys] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([ADT_REF_ID_SameSys]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_FasterDiagnosisExclusionReasonCode] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([FasterDiagnosisExclusionReasonCode]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_FasterDiagnosisOrganisationCode] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([FasterDiagnosisOrganisationCode]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [tblMAIN_REFERRALS_mvw_UH_HashBytesValue] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([HashBytesValue]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_HospitalNumber] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([HospitalNumber]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_IsSCR] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([IsSCR]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_L_CANCER_SITE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([L_CANCER_SITE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_L_DIAGNOSIS] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([L_DIAGNOSIS]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_L_ORG_CODE_DIAGNOSIS] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([L_ORG_CODE_DIAGNOSIS]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_L_OTHER_DIAG_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([L_OTHER_DIAG_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_L_PT_INFORMED_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([L_PT_INFORMED_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [tblMAIN_REFERRALS_mvw_UH_LastUpdated] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([LastUpdated]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_linkedcareID] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([LinkedCareID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N_UPGRADE_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N_UPGRADE_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N_UPGRADE_ORG_CODE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N_UPGRADE_ORG_CODE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N1_3_ORG_CODE_SEEN] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N1_3_ORG_CODE_SEEN]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_1_REFERRAL_SOURCE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_1_REFERRAL_SOURCE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_12_CANCER_TYPE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_12_CANCER_TYPE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_13_CANCER_STATUS] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_13_CANCER_STATUS]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_4_PRIORITY_TYPE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_4_PRIORITY_TYPE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_5_DECISION_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_5_DECISION_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_6_RECEIPT_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_6_RECEIPT_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N2_9_FIRST_SEEN_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N2_9_FIRST_SEEN_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N4_1_DIAGNOSIS_DATE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N4_1_DIAGNOSIS_DATE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N4_2_DIAGNOSIS_CODE] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N4_2_DIAGNOSIS_CODE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_N4_3_LATERALITY] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([N4_3_LATERALITY]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_NHSNumber] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([NHSNumber]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_NotRecurrence] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([NotRecurrence]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Ix_tblMAIN_REFERRALS_PatientPathwayID] ON [Merge_DM_Match].[tblMAIN_REFERRALS_mvw_UH_Excluded] ([PatientPathwayID]) ON [PRIMARY]
GO
