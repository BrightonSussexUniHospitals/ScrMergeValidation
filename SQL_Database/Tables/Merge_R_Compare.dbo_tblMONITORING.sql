CREATE TABLE [Merge_R_Compare].[dbo_tblMONITORING]
(
[DW_tblMONITORING_ID] [bigint] NOT NULL IDENTITY(1, 1),
[DW_LOAD_ID] [int] NULL,
...
[L_MONITORING_INTENT] [varchar] (60) COLLATE Latin1_General_CI_AS NULL,
