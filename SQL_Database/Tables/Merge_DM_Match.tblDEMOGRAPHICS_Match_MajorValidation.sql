CREATE TABLE [Merge_DM_Match].[tblDEMOGRAPHICS_Match_MajorValidation]
(
...
[ValidationStatus] [varchar] (255) COLLATE Latin1_General_CI_AS NULL,
[PATIENT_ID] [int] NULL,
...
GO
CREATE UNIQUE CLUSTERED INDEX [PK_tblDEMOGRAPHICS_Match_MajorValidation] ON [Merge_DM_Match].[tblDEMOGRAPHICS_Match_MajorValidation] ([SrcSys_Major], [Src_UID_Major]) ON [PRIMARY]
GO
