...
CREATE PROCEDURE [Merge_DM_Match].[uspSSRS_Merge_DM_Data]
...
-- EXEC Merge_DM_Match.uspSSRS_Merge_DM_Data @tableName = 'tblDEMOGRAPHICS', @SrcSys = 1, @Src_UID = '47632'
		...
		BEGIN
				-- Recalculate the links for all related majors
				EXEC Merge_DM_Match.tblDEMOGRAPHICS_uspMatchEntityPairs @MajorID_SrcSys = @SrcSys, @MajorID_Src_UID = @Src_UID, @UseExistingMatches = 1
