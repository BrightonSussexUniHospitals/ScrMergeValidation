...
CREATE PROCEDURE [Merge_DM_Match].[tblDEMOGRAPHICS_uspMatchControlUpdate] AS 
...
Description:				A stored procedure to update the tblDEMOGRAPHICS data used in the matching
							and validation process with changes in the source data
**************************************************************************************************************************************************/

-- Test me
-- EXEC Merge_DM_Match.tblDEMOGRAPHICS_uspMatchControlUpdate
